  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((d < 0)) {
        ...
        var array$1 = [((((-$uD(b$2.apply__O())) - $uD($g["Math"]["sqrt"](d))) / 2) * $uD(a$2.apply__O())), ((((-$uD(b$2.apply__O())) + $uD($g["Math"]["sqrt"](d))) / 2) * $uD(a$2.apply__O()))];
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$getColor$1__I__T = (function(num) {
  return ((num >= 15) ? "green" : ((num >= 0) ? "orange" : "red"))
});
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$getColor$1__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
